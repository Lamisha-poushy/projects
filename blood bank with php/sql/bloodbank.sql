...
--
-- Insert data for table `bloodrequest`
--
...
--
-- Insert data for table `hospitals`
--

INSERT INTO `hospitals` (`id`, `hname`, `hemail`, `hpassword`, `hphone`, `hcity`) VALUES
(1, 'X hospital', 'x123@gmail.com', 'x123', '7865376358', 'Dhaka'),
(2, 'y Hospital', 'y123@gmail.com', 'y123', '9876543267', 'Dhaka');
...
--
-- Insert data for table `receivers`
--

INSERT INTO `receivers` (`id`, `rname`, `remail`, `rpassword`, `rphone`, `rbg`, `rcity`) VALUES
(1, 'abc', 'abc@gmail.com', 'abc', '8875643456', 'A+', 'Dhaka'),
(2, 'xyz', 'xyz@gmail.com', 'xyz', '8875643456', 'AB+', 'Dhaka');
